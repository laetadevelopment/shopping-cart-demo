...
type Cart struct {
	...
	Tests                []*Cart_Item         `protobuf:"bytes,2,rep,name=tests,proto3" json:"tests,omitempty"`
...
func (m *Cart) GetTests() []*Cart_Item {
	if m != nil {
		return m.Tests
	}
	return nil
...
func (m *Cart_Item) GetShopifyId() int64 {
	if m != nil {
		return m.ShopifyId
	}
	return 0
...
func (m *Cart_Item) GetSrc() string {
	if m != nil {
		return m.Src
	}
	return ""
...
func (m *Cart_Item) GetAlt() string {
	if m != nil {
		return m.Alt
	}
	return ""
...
func (m *Cart_Item) GetPosition() string {
	if m != nil {
		return m.Position
	}
	return ""
...
var fileDescriptor_eb9f7b8935c2f010 = []byte{
	...
	,
}
